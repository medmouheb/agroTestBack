...
public interface DeliveryInstructionRepository  extends MongoRepository <DeliveryInstruction , String> {
    ...
    Page<DeliveryInstruction> findByFarmerAndIsDeletedAndInstructiuonNameContainingIgnoreCase(String farmer,Boolean isDeleted, String productType , Pageable pageable);
