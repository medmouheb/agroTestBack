...
public class FactureController {
    ...
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody FactureDto campany) throws DocumentException, FileNotFoundException {
        FactureDto response = factureService.create(campany);
    ...
    @PreAuthorize("hasRole('EMPLOYEE') or hasRole('FARMER') or hasRole('ADMIN')")
    @PutMapping("/{id}")
    public ResponseEntity<?> update(@PathVariable String id, @RequestBody FactureDto campany) throws NotFoundException {
        FactureDto response = factureService.update(id, campany);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    @PreAuthorize("hasRole('EMPLOYEE') or hasRole('FARMER') or hasRole('ADMIN')")
    @GetMapping("/{id}")
    public ResponseEntity<?> findAll(@PathVariable String id) throws NotFoundException {
        FactureDto response = factureService.findById(id);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    @PreAuthorize("hasRole('EMPLOYEE') or hasRole('FARMER') or hasRole('ADMIN')")
    @GetMapping("")
    public ResponseEntity<?> findAll() {
        List<FactureDto> response = factureService.findAll();
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    @PreAuthorize("hasRole('EMPLOYEE') or hasRole('FARMER') or hasRole('ADMIN')")
    @GetMapping("/page")
    ...
    public ResponseEntity<?> findArchivedPage(
        ...
        if(t.get().equals("admin")){
            response= factureService.getpagesarchive(pageSize, pageNumber, filter);
        }else {
            response= factureService.getpagesarchive1(pageSize, pageNumber, filter,farmername);
        }
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    @PreAuthorize("hasRole('EMPLOYEE') or hasRole('FARMER') or hasRole('ADMIN')")
    ...
    public ResponseEntity<?> archive(@PathVariable String id) throws NotFoundException {
        factureService.archive(id);
        return new ResponseEntity<>(HttpStatus.OK);
    }
    @PreAuthorize("hasRole('EMPLOYEE') or hasRole('FARMER') or hasRole('ADMIN')")
    @GetMapping("/desarchiver/{id}")
    public ResponseEntity<?> setNotArchive(@PathVariable String id) throws NotFoundException {
        factureService.setNotArchive(id);
        return new ResponseEntity<>(HttpStatus.OK);
    }
}
