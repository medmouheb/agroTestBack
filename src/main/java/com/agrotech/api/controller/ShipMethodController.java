...
public class ShipMethodController {
    ...
    @PreAuthorize("hasRole('EMPLOYEE') or hasRole('FARMER') or hasRole('ADMIN')")
    @PostMapping("")
    public ResponseEntity<?> create(@RequestBody ShipMethodsDto campany) throws DocumentException, FileNotFoundException {
    ...
    public ResponseEntity<?> findArchivedPage(
        ...
        if(getRole().equals("admin")){
            ...
            if(getRole().equals("employee")){
                Page<ShipMethods> response = shipMethodsService.getpagesarchiveFarmer(userService.getFarmerByUsername(getusername()).get(),pageSize, pageNumber, filter);
                return new ResponseEntity<>(response, HttpStatus.OK);
            }
            Page<ShipMethods> response = shipMethodsService.getpagesarchiveFarmer(getusername(),pageSize, pageNumber, filter);
            return new ResponseEntity<>(response, HttpStatus.OK);
        }
    }
