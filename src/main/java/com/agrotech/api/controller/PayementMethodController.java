...
public class PayementMethodController {
    ...
    public ResponseEntity<?> findArchivedPage(
        ...
        if(getRole().equals("admin")){
            ...
            if(getRole().equals("employee")){
                Page<PaymentMethod> response = paymentMethodService.getpagesarchiveFarmer(userService.getFarmerByUsername(getusername()).get(),pageSize, pageNumber, filter);
                return new ResponseEntity<>(response, HttpStatus.OK);
            }
            Page<PaymentMethod> response = paymentMethodService.getpagesarchiveFarmer(getusername(),pageSize, pageNumber, filter);
            return new ResponseEntity<>(response, HttpStatus.OK);
        }
